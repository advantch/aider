...
class AnthropicClient:
    ...
    def __init__(self, api_key: Optional[str] = None):
        ...
        if not self.api_key:
            raise ValueError(
                "No Anthropic API key provided. Use --anthropic-api-key or set ANTHROPIC_API_KEY env var."
            )
                ...
                "choices": [
                    {
                        ...
                        "finish_reason": "stop" if result.get("stop_reason") == "stop_sequence" else result.get("stop_reason", "unknown")
                    }
                ],
                "usage": {
